...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 14 02:22:35 2026
...
qq = ax.imshow(arr, origin='lower', extent=[xmin, xmax, zmin, zmax], cmap='jet',alpha=0.2,)# vmax=24, vmin = 23)
ax.set_title(f'{model_number} {FIELD} at y={y0}',fontsize=fontsize+4)
...
#ax.quiverkey(speed, X=0.85, Y=1.02, U=v_ref,label=f'{v_ref} mm/yr', labelpos='E',coordinates='axes')
