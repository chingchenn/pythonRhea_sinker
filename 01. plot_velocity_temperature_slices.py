...
# -*- coding: utf-8 -*-
"""
reated on Tue Sep 30 18:48:25 2025
...
for kkk, mmm in enumerate(slices_list):
    ...
    arr = np.asarray(sampled.point_data[FIELD]).reshape(nz, nx, order='F')/1400
    ...
    qq = aa.imshow(arr, origin='lower', extent=[xmin, xmax, zmin, zmax], cmap='jet',vmin=0,vmax=1,alpha=0.2)
